...
// Starter C: RICH SERIAL READOUT   (the simplest of the three)
// ============================================================
//
...
//   and prints a rich message with the CATEGORY WORD and your time,
//   for example:
//       FAST! 210 ms
//       MEDIUM. 380 ms
//       SLOW. 600 ms
//   There are no extra LEDs or buzzer patterns in this one -- all the
//   feedback comes through the Serial Monitor. This makes it the easiest
//   starter to read and change first.
//
...
void setup() {
  ...
  Serial.println("=================================");
  Serial.println("   REACTION TIME GAME (serial readout)");
  Serial.println("=================================");
  Serial.println("Wait for the LED to turn ON and BEEP,");
  Serial.println("then press the button as FAST as you can!");
  Serial.println("Watch this screen for your category and time.");
...
void loop() {
  ...
  // ---- STEP 6: Decide the category and print a rich message ----
  // We compare reactionTime to the thresholds at the top of the file,
  // then print the category WORD followed by the time, e.g. "FAST! 210 ms".
