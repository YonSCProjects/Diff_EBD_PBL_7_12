# Comprehensive Academic Review: Robotics, PBL, and Emotional/Behavioral Disorders (2016-2026)

Based on a thorough sweep of the OpenAlex global research database (which indexes Crossref, PubMed, and institutional repositories), the intersection of **Project-Based Learning**, **Robotics**, and **Emotional/Behavioral Disorders (EBD/ADHD)** has distinct, verified clusters of research.

Here is the 100% verified literature, confirmed with DOIs:
...
## 3. High-School/College ADHD Robotics & Coaching
* **O'Connell, A. & Banga, A. (2024).** "Design and Evaluation of a Socially Assistive Robot Schoolwork Companion for College Students with ADHD" (*ACM*). DOI: 10.1145/3610977.3634929
  * *Relevance:* Applies the concepts of "body doubling" and externalized executive function. An external system (a robot or milestone tracker) keeps neurodivergent students anchored to the project without triggering ODD/defiance.
